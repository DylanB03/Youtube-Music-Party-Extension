/* eslint-disable */
// Generated by Wrangler by running `wrangler types src/worker-configuration.d.ts` (hash: 2236f60f2024a3204eede6f17ecc23dc)
// Runtime types generated with workerd@1.20260701.1 2026-07-01 nodejs_compat
interface __BaseEnv_Env {
	INVITES: KVNamespace;
	CREATE_ROOM_RATE_LIMITER: RateLimit;
	JOIN_ROOM_RATE_LIMITER: RateLimit;
	API_RATE_LIMITER: RateLimit;
	PARTY_ROOMS: DurableObjectNamespace<import("./index").PartyRoom>;
}
